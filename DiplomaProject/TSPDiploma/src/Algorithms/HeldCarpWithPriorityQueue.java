 ...
 * @author Yaryna
 */
// simple exact HeldCarpWithPriorityQueue solver based on branch-and-bound/Held--Karp
import java.io.*;
import java.util.*;
import java.util.regex.*;

public class HeldCarpWithPriorityQueue {
  // number of cities
  private int n;
  // city locations
  private double[] x;
  ...
  public static void main(String[] args) throws IOException {
    ...
    // assume TYPE: HeldCarpWithPriorityQueue, EDGE_WEIGHT_TYPE: EUC_2D
    // no error checking
    HeldCarpWithPriorityQueue tsp = new HeldCarpWithPriorityQueue();
